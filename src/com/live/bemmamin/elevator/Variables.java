...
public final class Variables {
   ...
   private boolean factionsSupport;
   ...
   void loadVariables() {
      ...
      this.bossBarEnabled = config.getBoolean("bossBarEnabled", true) && !version("1.7") && !version("1.8");
      ...
      this.factionsSupport = config.getBoolean("factionsSupport", true);
      this.disableInCombat = config.getBoolean("disableInCombat", false);
   }
   ...
   public boolean isFactionsSupport() {
      return this.factionsSupport;
   }
